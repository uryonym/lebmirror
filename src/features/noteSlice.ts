...
export const noteSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(changeNote.pending, (state) => ({
      ...state,
      status: 'loading',
    }))
    ...
    builder.addCase(changeNote.rejected, (state) => ({
      ...state,
      status: 'failed',
    }))
    builder.addCase(destroyNote.pending, (state) => ({
      ...state,
      status: 'loading',
    }))
    ...
    builder.addCase(destroyNote.rejected, (state) => ({
      ...state,
      status: 'failed',
    }))
  },
